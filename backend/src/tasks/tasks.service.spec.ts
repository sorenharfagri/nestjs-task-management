...
describe('TasksService', () => {
    ...
    describe('getTasks', () => {
        it('gets all tasks from repository', async () => {
            ...
            const filters: GetTasksFilterDto = { status: TaskStatus.IN_PROGRESS, search: 'someSearchQuery' }
    ...
    describe('createTask', () => {
        ...
        it('calls taskRepository.createTask() and returns the result', async () => {
            const mockCreateTaskDto: CreateTaskDto = { title: 'Test Title', description: 'Test Description' }
            const mockTask = { title: mockCreateTaskDto.title, description: mockCreateTaskDto.description }
